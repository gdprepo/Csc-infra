...
Route::get('/dashboard/site/slider/add', 'TexteController@slideradd')->name('slider.add');
Route::post('/dashboard/site/slider/create', 'TexteController@storeSlider')->name('slider.store');
